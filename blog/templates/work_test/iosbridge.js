...
(function(mdSmartios) {
	...
	*/
	 ...
	 * {
	 * "method":"GET", //POST/GET, 默认POST
	 * "headers":{},//请求header
	 * "data":{},//请求参数
	 * "hostUrl":"http://172.16.13.138", //接口host
	 * "secret":"test_secret", //电商的appSecret，可选，默认不传
	 * "url":"/next/outer_assets/getcouponlist"//接口ur
	 * }
	 * @return callback(result)
	 * result: {
	 * errorCode:0, //0：服务器错误，-1请求超时, 999999 没有网络
	 * errorMessage:'xxx', //本地错误信息
	 * }
	 */
	mdSmartios.bridge.sendElectronicRequest = function (param, callback, callbackFail) {
		return mdSmartios.bridge.interfaceWrapper('sendElectronicRequest', param, callback, callbackFail);
	};
	/**
	 * 字节埋点接口(6.8）
	 * @param {json} param
     ...
     * @param {json} param
     * {
        "path":"pages/index/index?invitationCode=4f5286a582c1c194",
        "hdImageData":"",
        "invitationExpiration":1800,
        "withShareTicket":true,
        "userName":"gh_bf92931b2bd6",
        "webpageUrl":"http://iot4.midea.com.cn/downloads/app/index.html",
     ...
     *
     */
    mdSmartios.bridge.inviteFamily = function (param, callback, callbackFail) {
        return mdSmartios.bridge.interfaceWrapper('inviteFamily', param, callback, callbackFail);
    };
     ...
     *
     */
    mdSmartios.bridge.bindThirdParty = function (param, callback, callbackFail) {
        return mdSmartios.bridge.interfaceWrapper('bindThirdParty', param, callback, callbackFail);
    };

    /**
     * 更新，获取已经绑定第三方应用的unionid(6.6.1）
     * @param {{type: string}} param
     * {
        type: 'wx'//wx: 微信
        }
     ...
     *                   1109: 第三方账户没有授权
     */
    mdSmartios.bridge.getUnionId = function (param, callback, callbackFail) {
        return mdSmartios.bridge.interfaceWrapper('getUnionId', param, callback, callbackFail);
    };
     ...
     * 美居6.4.0 关闭键盘
     */
    mdSmartios.bridge.killkeyboard = function () {
        console.log("function:mdSmartios.bridge.killkeyboard");
        return mdSmartios.bridge.po._execObjcMethod('killkeyboard');
    };
     ...
     * @returns {*}
     */
    mdSmartios.bridge.openNativeSystemSetting = function (settingName) {
        console.log("function:mdSmartios.bridge.openNativeSystemSetting");
        let p = JSON.stringify({
            controlPanelName : controlPanelName + '.html'
        });
        return mdSmartios.bridge.po._execObjcMethod('openNativeSystemSetting', p);
    };
    ...
    */
    mdSmartios.bridge.startCmdV2Process = function(messageBody, callback, callbackFail) {
        ...
        let commandId = mdSmartios.bridge.po._execObjcMethod('startCmdV2Process', p);
        return commandId;
    };
    ...
    mdSmartios.bridge.sendMessage = function(param, callback, callbackFail) {
        ...
        let commandId = mdSmartios.bridge.po._execObjcMethod('sendMessage', p);
